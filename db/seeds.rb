...
#создание жанров
genres_names=%w(Боевик Вестерн Детектив Драма Комедия Комикс Мелодрама Мистика Мультфильм Политика Приключения Триллер Ужастик Фантастика Фэнтези)
...
terminator=Film.new(:name=>"Терминатор 2: Судный день", :origin_name=>"Terminator 2: Judgment Day",
                       :slogan=>"Same Make. Same Model. New Mission.",:length=>137,:year=>1991,:trailer_url=>"oL1RE8JXaIw",:people=>[schwarznegger,hamilton])
...
puts "OK"
#terminator.genres.create()

titanic=Film.new(:name=>"Титаник", :origin_name=>"Titanic",
                       :slogan=>"Ничто на Земле не сможет разлучить их.", :length=>194,:year=>1997,:trailer_url=>"zCy5WQ9S4c0",:people=>[dikaprio,uinslet])
titanic.description=<<DESC
Молодые влюбленные Джек и Роза находят друг друга в первом и последнем плавании «непотопляемого» Титаника. Они не могли знать, что шикарный лайнер столкнется с айсбергом в холодных водах Северной Атлантики, и их страстная любовь превратится в схватку со смертью…
DESC
puts "TITANIC SAVED: #{titanic.save}"
#titanic.genres.create()
